...
//  ContentView.swift
=======
//  ContentView.swift (LEGACY FILE - NOT USED IN APP)
...
=======
//  NOTE: This file is not used in the app. The actual main view is MainContentView in DTSApp.swift
//  This file is kept for reference but does not participate in the build process.
//  Original file backed up as ContentView.swift.original

import SwiftUI

// This ContentView is not used - MainContentView in DTSApp.swift is the actual entry point
struct ContentView_Legacy: View {
    var body: some View {
        Text("This view is not used - see MainContentView in DTSApp.swift")
            .foregroundColor(.secondary)
>>>>>>> jobber-integration-complete
    }
}
